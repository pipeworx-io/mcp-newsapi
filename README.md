...
`tools/list` at `https://gateway.pipeworx.io/newsapi/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/newsapi_top_headlines \
  -H 'Content-Type: application/json' \
  -d '{"country":"us","category":"technology","pageSize":10}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/newsapi_top_headlines`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
